...
/**
* @see \App\Http\Controllers\AdCampaignController::payment
 * @see app/Http/Controllers/AdCampaignController.php:76
 * @route '/advertising/campaigns/{campaign}/payment'
 */
export const payment = (args: { campaign: string | number | { id: string | number } } | [campaign: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/advertising/campaigns/{campaign}/payment'
 */
payment.url = (args: { campaign: string | number | { id: string | number } } | [campaign: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
 ...
 * @route '/advertising/campaigns/{campaign}/payment'
 */
payment.post = (args: { campaign: string | number | { id: string | number } } | [campaign: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: payment.url(args, options),
    method: 'post',
})
 ...
 * @route '/advertising/campaigns/{campaign}/payment'
 */
    const paymentForm = (args: { campaign: string | number | { id: string | number } } | [campaign: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/advertising/campaigns/{campaign}/payment'
 */
        paymentForm.post = (args: { campaign: string | number | { id: string | number } } | [campaign: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: payment.url(args, options),
            method: 'post',
        })
